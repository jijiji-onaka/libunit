...
/*   Updated: 2021/05/11 16:09:54 by tjinichi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	split_launcher(void)
{
	...
	load_test(&testlist, "Empty Test         ", &split_empty1_test);
	load_test(&testlist, "Empty Test         ", &split_empty2_test);
	load_test(&testlist, "Empty Test         ", &split_empty3_test);
